//add moderator to all contests in hacckerrank
//install puppeteer
//launch browser and page
//type
//click
//node activity-2.js --url="https://www.hackerrank.com" --config=config.json
//intall minimist
...
await cpage.waitFor(3000);
  ...
  await cpage.type("input#moderator",configJSO.moderator ,{delay:50});
  //press enter
